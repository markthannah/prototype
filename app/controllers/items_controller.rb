class ItemsController < ApplicationController
  ...
  private
    ...
    def item_params
      params.require(:item).permit(:name, :barcode, :category, :designer, :hallmarks, :style , :metaltype, :othermetal, :totalweight, :length, :ringsize, :weighttype, :braceletclosure, :broochclosure, :earringclosure, :braceletdesigner,:bracelethallmarks,:braceletlength,:braceletmetaltype,:braceletothermetal,:braceletstyle,:bracelettotalweight,:braceletweighttype,:broochdesigner,:broochhallmarks,:broochmetaltype,:broochothermetal,:broochstyle,:broochtotalweight,:broochweighttype,:cufflinkhallmarks,:cufflinkmetaltype,:cufflinkothermetal,:cufflinkstyle,:cufflinktotalweight,:cufflinkweighttype,:earringdesigner,:earringhallmarks,:earringmetaltype,:earringothermetal,:earringstyle,:earringtotalweight,:earringweighttype,:necklacedesigner,:necklacehallmarks,:necklacelength,:necklacemetaltype,:necklaceothermetal,:necklacestyle,:necklacetotalweight,:necklaceweighttype,:pendantdesigner,:pendanthallmarks,:pendantmetaltype,:pendantnecklaceclosuretype,:pendantnecklacelength,:pendantothermetal,:pendantstyle,:pendanttotalweight,:pendantweighttype,:pinhallmarks,:pinmetaltype,:pinothermetal,:pinstyle,:pintotalweight,:pinweighttype,:ringdesigner,:ringhallmarks,:ringmetaltype,:ringothermetal,:ringstyle,:ringtotalweighttype,:ringweighttype,:watchbezelmetal,:watchcasebackmetal,:watchdialmarks,:watchmaker,:watchmarksback,:watchmarksinside,:watchmovement)
    end
end
